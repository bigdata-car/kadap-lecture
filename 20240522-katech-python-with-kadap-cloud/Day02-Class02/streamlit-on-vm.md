...
```bash
#사용자 변경(비밀번호 kadap1234), ubuntu는 관리용 입니다.  
$ (ubuntu) su root
#python 및 python 패키지 설치 툴(pip) 설치, 최초 설치시 시간 소요
$ sudo apt update; sudo apt install python3-pip wget 
...
#코드 실행 하기 
$ streamlit run streamlit-final.py --server.port 30001 
```
